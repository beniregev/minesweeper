...
public class MineField {
    ...
    public int numAdjacentMines(int row, int col) {
        ...
        //  check left top corner square, the coordinate should be in range or just skip checking
        if(hasMine(row-1,col-1) && inRange(row-1,col-1)) {
            adjacentMines++;
        }
    ...
    /**
     * Returns true iff (row,col) is a valid field location.  Row numbers and column numbers start from 0.
