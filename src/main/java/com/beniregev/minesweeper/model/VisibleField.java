...
/**
 * <h1>VisibleField class</h1>
 * <p>
 *     This is the data that's being displayed at any one point in the game (i.e., visible field, because it's
 *     what the user can see about the minefield), Client can call getStatus(row, col) for any square.
 * </p>
 * <p>
 *     It actually has data about the whole current state of the game, including the underlying mine field
 *     (getMineField()).  Other accessors related to game status: numMinesLeft(), isGameOver().
 * </p>
 * <p>
...
public class VisibleField {
    ...
    /**
     * Create a visible field that has the given underlying mineField. The initial state will have all the mines
     * covered up, no mines guessed, and the game not over.
     ...
     * @return the status of the square at location (row, col).  See the public constants at the beginning of the
     * class for the possible values that may be returned, and their meanings.
    ...
    /**
     * Returns the the number of mines left to guess.  This has nothing to do with whether the mines guessed are
     * correct or not.  Just gives the user an indication of how many more mines the user might want to guess. So
     * the value can be negative, if they have guessed more than the number of mines in the minefield.
