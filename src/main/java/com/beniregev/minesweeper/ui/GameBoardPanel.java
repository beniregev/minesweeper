 ...
 * <div>
 *     <div>
 *         <h1>GameBoardPanel class</h1>
 *         <p>
 *             This is the GUI for the program: it contains the display and controls for a game, and the minefield
 *             display (grid of "buttons").  It's the View and Controller in the MVC design pattern, whereas the
 *             Model is the VisibleField and MineField.
 *         </p>
 *         <p>
 ...
 *     </div>
 *     <div>
 *         <h2>Design of the GameBoardPanel:</h2>
 *         <p>
 *             The game data (Model) is in the visibleField instance variable (and the underlying minefield
 *             in {@code visibleField().getMineField()}).     *
 *         </p>
 *         <p>
 *             Contains inner classes SquareView (a JLabel) and SquareListener (a MouseListener for that label),
 *             which are the View and Controller, respectively, for an individual square (one instance of each
 *             of these is created for each square on the board).
 *         </p>
 *         <p>
 *             The Model for a single square is not a separate class, but is collectively part of visibleField
 *             and can be accessed using VisibleField methods getStatus(row, col) and isCovered(row, col), and
 *             can be mutated with VisibleField methods cycleGuess(row, col) and uncover(row, col) [the last of
 *             these can change more than one square]
 *         </p>
 *     </div>
 * </div>
